...
const NAV = [
  ...
  { to: "/admin/comments", icon: "💬", label: "Commentaires" },
    ...
    <div className="flex min-h-screen" style={{ background: "#0e0822" }}>
      ...
      >
        ...
        <div className="flex items-center gap-2.5 px-2.5 mb-9">
          ...
          <div>
            <div className="font-ubuntu font-bold text-[15px] text-base-content/90">
              Jonathan
            </div>
            <div className="font-mono text-[10px] text-white/30 tracking-[1px]">
              Admin Panel
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-4 mt-4 px-2">
          <div className="font-mono text-[11px] text-white/30 mb-3 truncate">
            {admin?.email}
          </div>
          <button
